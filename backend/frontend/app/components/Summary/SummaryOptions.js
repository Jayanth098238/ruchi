...
const SummaryOptions = ({ article, onSummaryUpdated }) => {
  ...
  const handleRegenerateSummary = async (length) => {
    setLoading(true);
    setError('');
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-4">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-medium text-gray-900">Article Summary</h3>
        <button
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className="bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:opacity-50 text-sm"
            >
          ...
          {Object.keys(summaries).length > 0 && (
            <div className="space-y-3">
              <h4 className="font-medium text-gray-900">Generated Summaries:</h4>
              {['short', 'medium', 'long'].map((length) => (
                summaries[length] && (
                  <div key={length} className="bg-gray-50 p-3 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
